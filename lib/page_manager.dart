...
import 'model/qq_song_list.dart';
import 'notifiers/play_button_notifier.dart';
import 'notifiers/progress_notifier.dart';
import 'notifiers/repeat_button_notifier.dart';

class PageManager {
  final currentSongTitleNotifier = ValueNotifier<String>('仅供学习交流');
  ...
  void loadSongList(String songId) async {
    //在此获取歌曲列表，可以是本地，也可以是接口请求，然后通过_playlist的add或addAll方法添加
  }
}
